...
#[derive(Clone, Debug, Eq, Hash, PartialEq, RustcEncodable, RustcDecodable, HashStable)]
pub struct Terminator<'tcx> {
    pub source_info: SourceInfo,
    pub kind: TerminatorKind<'tcx>,
}

#[derive(Clone, Eq, PartialEq, Hash, RustcEncodable, RustcDecodable, HashStable)]
...
/// A unique identifier for a local (and possibly a field of said local) on a
/// line of code.
#[derive(Clone, Copy, Debug, Eq, Hash, HashStable, PartialEq)]
pub struct UniqueId {
    pub def_id: DefId,
    pub local: Local,
...
/// A use of a shared object in a transaction.
#[derive(Clone, Copy, Debug, Eq, Hash, HashStable, PartialEq)]
pub struct TransactionUse {
    pub shared_object: UniqueId,
    pub is_write: bool,
}
...
pub struct AllocationSet {
    pub lock: UniqueId,
    pub unlock: UniqueId,
    pub allocations: Vec<TransactionUse>,
}

#[derive(Clone, Debug, Eq, Hash, HashStable, PartialEq)]
...
#[derive(Copy, Clone, PartialEq, Eq, Hash, Ord, PartialOrd, HashStable, RustcEncodable, RustcDecodable)]
pub struct Location {
